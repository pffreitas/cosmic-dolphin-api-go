...
`func NewWebSocketMessageData(title string, summary string, tags string, type_ NoteType, sections []NoteSection, userId string, createdAt time.Time, ) *WebSocketMessageData`
...
`func (o *WebSocketMessageData) GetType() NoteType`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *WebSocketMessageData) GetTypeOk() (*NoteType, bool)`
...
`func (o *WebSocketMessageData) SetType(v NoteType)`
