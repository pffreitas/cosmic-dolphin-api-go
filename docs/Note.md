...
`func NewNote(title string, summary string, body string, type_ NoteType, userId string, createdAt string, ) *Note`
...
`func (o *Note) GetResources() []Resource`

GetResources returns the Resources field if non-nil, zero value otherwise.

### GetResourcesOk

`func (o *Note) GetResourcesOk() (*[]Resource, bool)`
...
`func (o *Note) SetResources(v []Resource)`

SetResources sets Resources field to given value.

### HasResources

`func (o *Note) HasResources() bool`
